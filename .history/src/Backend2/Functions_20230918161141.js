...
const signup = async (req, res) => {
  try {
    ...
    const token = jwt.sign({ email: result.email, id: result._id }, "iammohitsutharfromjawalsirohirajasthan");
...
const signin = async (req, res) => {
  try {
    ...
    const token = jwt.verify(
      {
        userModules.email === existinguser.email
      },
      "iammohitsutharfromjawalsirohirajasthan"
    );
