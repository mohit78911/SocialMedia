        ...
        <Box className="ActivityButtons">
          <Box>
            <Button className="activitybtn" onClick={postingStatusHandler}>
              <LiveTvIcon className="logoColor"></LiveTvIcon>
            ...
            >
              <PhotoSizeSelectActualIcon className="logoColor"></PhotoSizeSelectActualIcon>
            ...
            >
              <CameraAltIcon className="logoColor"></CameraAltIcon>
            ...
            <>
              <Box className="postfeed">
                <Box className="mainStatusbox">
                  ...
                  >
                    <DeleteIcon className="logoColor"></DeleteIcon>
                  </Button>
                </Box>
              </Box>
            </>
