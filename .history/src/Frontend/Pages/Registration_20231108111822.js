    ...
    <Box className="RegistrationBackground">
      <Box className="register">
        ...
        <Box className="secondContainer">
          <Box
            component="img"
            src="https://marketing.webassets.siemens-healthineers.com/d5102e3449ccf84b/1e9c31835823/siemens-healthineers_siemens-healthineers_mi_spect_ct_imaging_registration.gif"
            width={"100%"}
