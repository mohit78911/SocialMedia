    ...
    <Box>
      <Box className="flex-contain">
        <Box className="oneContain">
          <Box
            component="img"
            src="https://assets.mixkit.co/videos/preview/mixkit-exploding-ink-underwater-105-large.mp4https://storage.googleapis.com/pai-images/def5837fff8541f9bf92db053a3eeeec.jpeg"
            width={"100%"}
            className="imglogin"
          />
        </Box>
