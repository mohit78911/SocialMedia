              ...
              <Box key={i}>
                <Box className="userField">
                  <Box className="topBar">
                    <Box
                      component="img"
                      src={value.userId ? value.userId.userprofile : 'lkjfs'}
                      width={60}
                      className="profile"
                    />
                    <Box>
                      <Typography>{value.userId ? value.userId.name : undefined}</Typography>
                  ...
                  <Box className="feedimg">
                    <Box component="img" src={value.postId.image} width={"100%"} />
                  </Box>
