              ...
              <DialogContentText id="alert-dialog-slide-description">
                ...
                {details && (
                  <div className="userDetailsContainer">
                    ...
                    <div>
                      <span className="nameOpacity">Name</span> : {details.name}
                    </div>
                    <div>
                      <span className="nameOpacity">Email</span> : {details.email}
                    </div>
                    <div>
                      <span className="nameOpacity">Password</span> : {details.password}
                    </div>
                  </div> 
                  </div>
                )}
