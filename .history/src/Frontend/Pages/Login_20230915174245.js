...
export default function Login({userData}) {
  ...
  const addDataHandler = ()=>{
    const filterData =  userData.filter((val)=>val.email === email && val.password === password)

    const trimedEmail = email.trim().addDataHandler
      ...
      <div className="flex-contain">
        ...
        <div className="secondContain">
          <div className="loginContainer container">
            ...
            <div>
              <button className="loginbtn" onClick={addDataHandler}>Login</button>
            </div>
          </div>
        </div>
      </div>
