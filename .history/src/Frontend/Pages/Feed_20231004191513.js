        ...
        <Box className="postfeed">
          ...
          <Box className="inputBox">
                ...
                <Box key={j}>
                  <Box
                    component="img"
                    src={users.userprofile ? val[0].userprofile : "dfasf"}
                    width={50}
                    className="image"
                  />
                  <div>
                    {val ? <img src={val.userprofile} /> : <div>hyUser</div>}
                  </div>
                </Box>
            ...
            <Box>
              <Box className="userField">
                <Box className="topBar">
                  <Box
                    component="img"
                    src={users ? users.userprofile : null}
                    width={60}
                    className="profile"
                  />
                  <Box>
                    <Typography>{users ? users.name : null}</Typography>

                    <Typography style={{ opacity: "0.5" }}>
                      {users ? users.lastseen : null}
                    </Typography>
                  </Box>
                </Box>
                ...
                <Box className="likebtnsContainer">
                  <Button>
                    {users.like ? <FavoriteIcon /> : <FavoriteBorderIcon />}
                  </Button>
                </Box> */}
              </Box>
            </Box>
