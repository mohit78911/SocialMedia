...
export default function Feed({ users, handleClickOpen, handleClose, open }) {
  ...
  return (
    <>
      <button onClick={postLikeHandler}>postlike</button>
      <Box>
        <UploadComponent
          users={users}
            ...
            return (
              <Box key={i}>
                <Box className="userField">
                  ...
                  <button
                    onClick={() => {
                      postLikeHandler(value.postId._id);
                    }}
                  >
                    clickpost
                  </button>
                  <Box className="likebtnsContainer">
                    <Button
                      onClick={() => {
                        ...
                        setlikepostid(value.postId._id);
                      }}
                    >
                      {value.like ? (
                        <motion.a
                    ...
                    <Button
                      onClick={() => {
                        getCommentDataHandler(value.postId._id);
                        setCommentBox(true);
                      }}
                    >
                    ...
                    {commentBox ? (
                              ...
                              <Box className="mainCommentBox" key={value._id}>
                                <Box className="commentBox">
                                  <Box
                                    component="img"
                                    src={
                                      value ? value.userId.userprofile : null
                                    }
                                    width={40}
                                    className="profile"
                                  />
                      ...
                      <Box className="InputCommentBox">
                        ...
                        <Button
                          ...
                          onClick={() => commentPostHandler(value.postId._id)}
                        >
                          Submit
                        </Button>
                      </Box>
