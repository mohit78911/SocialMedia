                    ...
                    {commentBox ? (
                      <Box className="commentBox">
                        <Box
                          component="img"
                          src={
                            value.userId ? value.userId.userprofile : undefined
                          }
                          width={40}
                          className="profile"
                        />
                        &nbsp;&nbsp;
                        <Typography sx={{ opacity: "0.7", marginTop: "1vh" }}>
                          {value.commentId ? value.commentId.comment : null}
                        </Typography>
                      </Box>
                    ) : <Box className="InputCommentBox"><input placeholder="Comments, Whats on your Mind." className="InputComment"/><Button>Submit</Button></Box>}
                  </Box>
                </Box>
              </Box>
            );
