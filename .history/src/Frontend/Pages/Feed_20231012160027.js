              ...
              <Box key={i}>
                <Box className="userField">
                  ...
                  <Box className="topBar">
                    <Box
                      component="img"
                      src={value ? value.userprofile : undefined}
                      width={60}
                      className="profile"
                    />
                    <Box>
                      <Typography>{value ? value.name : undefined}</Typography>

                      <Typography style={{ opacity: "0.5" }}>
                        {value ? value.lastseen : undefined}
                      </Typography>
                    </Box>
                  </Box>
                  {/* post section */}
                      ...
                      <Box>
                        ...
                        <Box className="feedimg">
                          <Box
                            sx={{ cursor: "pointer" }}
                            component="img"
                            src={posts.? value.postId.image : null}
                            width={"100%"}
                          />
                        </Box>
                      </Box>
