      ...
      <div className="flex-contain">
        ...
        <div className="secondContain">
          <div className="loginContainer container">
            ...
            <Switch type="checkbox" checked={showPassword} onClick={visiblePassword} color="warning"/><label>Show Password</label>
            <div>
                <Button className="loginbtn" variant="none" fullWidth>Login</Button>
            </div>
          </div>
        </div>
      </div>
