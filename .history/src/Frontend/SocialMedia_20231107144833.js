...
//posting_new_friend_in_FriendList
const addingNewFriendsHandler = ()=>{
  axios.post(`http://localhost:6600/friendslist/addfriend`).then((result)=>{
    console.log("New Friend Added Successfully")
  }).catch((error)=>{
    console.log("errorWithAddingNewFriend",)
  })
}
  return (
    <Box>
      <Routes>
        ...
        <Route path="/home" element={<UserBook userData={userData} requestData={requestData} getRequestHandler={getRequestHandler} />} />
        <Route
          path="/register"
          element={
            <Registration
        ...
        <Route path="/settings" element={<Settings getRequestHandler={getRequestHandler} requestData={requestData}/>} />
